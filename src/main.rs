...
mod app {
    ...
    pub struct ParallelOutput {
        p_pulse: gpioa::PA6<Output<PushPull>>,
        p_reset: gpioa::PA5<Output<PushPull>>,
        p_inhibit: gpioa::PA4<Output<PushPull>>,
    }
    ...
    fn init(ctx: init::Context) -> (Shared, Local, init::Monotonics) {
        ...
        (
            ...
            Local {
                ...
                p_out: ParallelOutput {
                    p_pulse: gpioa.pa6.into_push_pull_output(),
                    p_reset: gpioa.pa5.into_push_pull_output(),
                    p_inhibit: gpioa.pa4.into_push_pull_output(),
                },
                p_in: ParallelInput {
                    // p_out_pulse: gpioa
                    //     .pa7
    ...
    #[idle(shared = [tick, request_queue], local = [
        tick_timer, heartbeat, indicator, p_out, main_instance])]
